...
```{r}
gcount_filt <- read.csv("/Users/laurenzane/Desktop/Putnam_Lab/Projects/Express_Compare/RAnalysis/Output/Pacuta/Pacuta_filtered_gene_count.csv") # gene counts filtered for PoverA(0.5,10)
...
# unique_gcount <- unique(gcount_filt)
...
DEG <- read.csv("~/Desktop/Putnam_Lab/Projects/Express_Compare/RAnalysis/Output/Pacuta/PacutaDEGSeq2.sig.results.csv", row.names=NULL) # significantly differentially expressed genes from DESeq2 results (16285 genes)
...
```{r}
gcount_filt_length_merge <- inner_join(gcount_filt, gene_length_final, by = "gene_id")
dim(gcount_filt_length_merge)
unique_length_merge <- unique(gcount_filt_length_merge[1])
length(unique_length_merge) # 684
...
write.csv(GO.wall, file = "/Users/laurenzane/Desktop/Putnam_Lab/Projects/Express_Compare/RAnalysis/Output/Pacuta/GOSeq/GO.wall.csv") # write csv to save to Output
```
...
write.csv(MF, file = "/Users/laurenzane/Desktop/Putnam_Lab/Projects/Express_Compare/RAnalysis/Output/Pacuta/GOSeq/Pacuta_MF_Sig_Enriched_GO_20220604.csv")
write.csv(CC, file = "/Users/laurenzane/Desktop/Putnam_Lab/Projects/Express_Compare/RAnalysis/Output/Pacuta/GOSeqPacuta_CC_Sig_Enriched_GO_20220604.csv")
write.csv(BP, file = "/Users/laurenzane/Desktop/Putnam_Lab/Projects/Express_Compare/RAnalysis/Output/Pacuta/GOSeq/Pacuta_BP_Sig_Enriched_GO_20220604.csv")
write.csv(enriched.GO.1, file = "/Users/laurenzane/Desktop/Putnam_Lab/Projects/Express_Compare/RAnalysis/Output/Pacuta/GOSeq/Pacuta_Sig_Enriched_GO_20220604.csv")
```
