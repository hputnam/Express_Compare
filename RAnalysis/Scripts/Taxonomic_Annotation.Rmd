...
#create a function to return the larger of the two values in bitscore to be used in group_modify

bigger <- function(bitscore){
  return(max(bitscore))
}
...
y <- x %>%
  ...
  group_modify(~{
    bigger(.x$bitscore)%>%
    tibble::enframe(name = "qseqid", value = "bigger")
  })
