...
treatmentinfo <- read.csv("/Users/laurenzane/Desktop/Putnam_Lab/Projects/Express_Compare/RAnalysis/Data/Mcap_RNAseq_metadata.csv", header = TRUE, sep = ",")
rownames(treatmentinfo) <- treatmentinfo$sample_num
str(treatmentinfo)
head(treatmentinfo)

#gene count matrix
gcount <- as.data.frame(read.csv("/Users/laurenzane/Desktop/Putnam_Lab/Projects/Express_Compare/hisat2_workflow/counts_matrices/MCap_gene_matrix.csv", row.names="gene_id"))
dim(gcount)
head(gcount)
colSums(gcount)
...
pdf(file = "/Users/laurenzane/Desktop/Putnam_Lab/Projects/Express_Compare/RAnalysis/Output/MCapPCAplot.pdf") #create file to save locally in the output folder
PCAplot
dev.off()
...
write.csv(DEGSeq2.sig.results, '/Users/laurenzane/Desktop/Putnam_Lab/Projects/Express_Compare/RAnalysis/Output/MCapDEGSeq2.sig.results.csv')  
...
pdf(file = "/Users/laurenzane/Desktop/Putnam_Lab/Projects/Express_Compare/RAnalysis/Output/MCapDEGSeq2_heatmap.pdf")
DEGSeq2_heatmap
dev.off()
```
...
ggsave(path = "/Users/laurenzane/Desktop/Putnam_Lab/Projects/Express_Compare/RAnalysis/Output", filename = "MCap_DEGSeq2_PCA_plot.pdf")

# PCA plot is of deferentially expressed genes only

# Save results

write.csv(counts(DEGSeq2_list), file="/Users/laurenzane/Desktop/Putnam_Lab/Projects/Express_Compare/RAnalysis/Data/MCapDEGSeq2_list_unique.csv")
