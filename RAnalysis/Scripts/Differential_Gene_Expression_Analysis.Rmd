...
gcount <- as.data.frame(read.csv("/Users/laurenzane/Desktop/Putnam_Lab/Projects/Express_Compare/RAnalysis/Data/Mcap/MCap_gene_matrix.csv", row.names="gene_id")) # mcap
...
tcount <- as.data.frame(read.csv("../../stringtie_assembly/counts_matrices/Pacuta-v2/transcript_count_matrix2.csv"))
```
...
t.keep <- rownames(tkeep)

#gene count data filtered in PoverA, P percent of the samples have counts over A
gcount_filt <- as.data.frame(gcount[which(rownames(gcount) %in% gn.keep),])
head(gcount_filt)
dim(gcount_filt) 
tcount_filt <- as.data.frame(gcount[which(rownames(tcount) %in% t.keep),])
head(tcount_filt)
dim(tcount_filt)
# save gcount filt as a .csv file for GOSeq
write.csv(gcount_filt, '/Users/laurenzane/Desktop/Putnam_Lab/Projects/Express_Compare/RAnalysis/Output/Pacuta/20220828_Pacuta-v2_filtered_gene_count.csv') 
...
pdf(file = "/Users/laurenzane/Desktop/Putnam_Lab/Projects/Express_Compare/RAnalysis/Output/Pacuta/20220828Pacuta-v2-PCAplot.pdf")
...
write.csv(DEGSeq2.sig.results, '/Users/laurenzane/Desktop/Putnam_Lab/Projects/Express_Compare/RAnalysis/Output/Pacuta/20220828_Pacuta-v2DEGSeq2.sig.results.csv')  
...
pdf(file = "/Users/laurenzane/Desktop/Putnam_Lab/Projects/Express_Compare/RAnalysis/Output/Pacuta/20220828PacutaDEGSeq2-v2_heatmap.pdf")
DEGSeq2_heatmap
dev.off()
...
DEGSeq2_PCA_plot <- ggplot(DEGSeq2_PCAdata, aes(PC1, PC2, color=method)) +
  ...
  theme(panel.border = element_blank(), # Set border
        ...
        axis.line = element_line(colour = "black"), #Set axes color
        plot.background=element_blank())+ #Set the plot background
  ggtitle("Pocillopora acuta version2")
